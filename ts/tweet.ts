class Tweet {
    ...
    get activityType():string {
        ...
        if (this.text.indexOf(" km ") != -1) {
            ...
            if ((!isNaN(this.text[this.text.indexOf("km ")-1] as any) || this.text[this.text.indexOf("km ")-1] ==".") && (!isNaN(this.text[this.text.indexOf("km ")-2] as any) || this.text[this.text.indexOf("km ")-2] ==".")) {
    ...
    get distance():number {
        ...
        if (this.text.indexOf(" km ") != -1) {
            return Number((this.text.substring(this.text.indexOf(" a ") + 3, this.text.indexOf(" km ")) as any)/1.609);
        }
        else if (this.text.indexOf(" mi ") != -1) {
            return Number(this.text.substring(this.text.indexOf(" a ") + 3, this.text.indexOf(" mi ")));
        }
        else if (this.text.indexOf("km ") != -1) {
            if ((!isNaN(this.text[this.text.indexOf("km ")-1] as any) || this.text[this.text.indexOf("km ")-2] ==".") && (!isNaN(this.text[this.text.indexOf("km ")-2] as any) || this.text[this.text.indexOf("km ")-2] ==".")) {
                return Number((this.text.substring(this.text.indexOf(" a ") + 3, this.text.indexOf("km "))) as any/1.609);
            }
        }
        else {
